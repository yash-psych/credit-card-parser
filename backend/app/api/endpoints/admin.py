...
def toggle_verify_user(
    ...
    """
    Toggles the verification status of a user (verifies or un-verifies).
    ...
    if user.role == models.UserRole.SUPER_ADMIN:
        raise HTTPException(status_code=403, detail="Cannot change verification status of a super admin.")
